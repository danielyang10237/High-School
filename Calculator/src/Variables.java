...
{ 
  ...
  { 
    ...
    eastPanel.setBackground(new Color(115,205,255));
 	...
 	// FINISH ME
 	// add your name
    titleLabel = new JLabel("Variables by Daniel Yang");
  ...
  { 
    ...
    // FINISH ME
    // add your name
    setTitle("Variables by Daniel Yang");
  ...
  public boolean isNumber(String number)
  {
	...
	{
		if (number.indexOf(i)!='0' && number.indexOf(i)!='1' && number.indexOf(i)!='2' && number.indexOf(i)!='3' && number.indexOf(i)!='4' && number.indexOf(i)!='5' && number.indexOf(i)!='6' && number.indexOf(i)!='7' && number.indexOf(i)!='8' && number.indexOf(i)!='9')
			return false;
	}
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    else if (source == calculateButton)
    {
		...
		if (!error && list.size()==1)
  	 	...
  	 	inputExpression.setText(expressionWithValues);	
    }
