/* DANIEL YANG <dy92634@eanesisd.net>
Thu, Sep 5, 10:36 AM (22 hours ago)
...
public class Calculator extends JFrame implements ActionListener,FocusListener
{
 ...
 char whichOperator = 'A';
 char secondWhichOperator = 'A';// indicates the current operator
 ...
 public Calculator()
 {
  ...
  // ****************************
  // ****************************
  super("CALCULATOR - Written by Daniel Yang");
  setSize(500,450);
    ...
    public void actionPerformed(ActionEvent e)
 {
  ...
  else if (whichOperator != '+' && whichOperator != '-' && whichOperator != '*' && whichOperator != '/' && whichOperator != '%' && whichOperator != '^')
  {
  ...
  else if ( (source == calcMenuItem) || (source == calcButton) )
  {
    ...
    //       but you will NOT do these for fractions
            ...
            else
            {
             ...
             else
             {
              ...
              if (secondWhichOperator != 'A')
              {
            	 sub = s1.substring(0,s1.indexOf(secondWhichOperator));
            	 x = Double.parseDouble(sub);
            	sub2 = s1.substring(s1.indexOf(secondWhichOperator)+1);
            	d = Double.parseDouble(sub2);
              }
              else
    ...
    if (whichOperator == '+' && secondWhichOperator == 'A')
    {
       z = x + y;
    }
    else if (whichOperator == '-' && secondWhichOperator == 'A')
    {
       z = x - y;
    }
    else if (whichOperator == '*' && secondWhichOperator == 'A')
    ...
    else if (whichOperator == '+' && secondWhichOperator == '+')
    {
        z = x + y + d;
     }
     else if (whichOperator == '+' && secondWhichOperator == '-')
       ...
       else if (whichOperator == '/' && secondWhichOperator == '+')
       {
        ...
        else if (whichOperator == '%' && secondWhichOperator == '+')
        {
         ...
         else if (whichOperator == '^' && secondWhichOperator == '+')
         {
          ...
          {
             z = Math.pow(Math.pow(x, d), y);
          }
    secondWhichOperator = 'A';
    // ***************************************************
    // ***************************************************
    // ***************************************************
 ...
 class Fraction
 {
  ...
  public Fraction add(Fraction other)
  {
   ...
   // FINISH ME
   // *********   
   double newDen = b * d; // CHANGE ME (LOOK ABOVE) 
  ...
  public Fraction exponent(Fraction other)
  {
   ...
   double c = other.numerator;
   double d = other.denominator;
    double newNum = (double) Math.pow(Math.pow(a,c), 1/d);
   
   // *********
   // FINISH ME
   // *********   
   double newDen = (double) Math.pow(Math.pow(b,c), 1/d);
   // *********************************************
   // *********************************************
   // *********************************************
  ...
  public Fraction modulus(Fraction other)
  {
   // *********************************************
   // *********************************************
   // *********************************************
   ...
   return new Fraction((double)newNum, newDen);  // CHANGE ME (LOOK ABOVE) 
  }
