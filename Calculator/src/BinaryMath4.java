...
public class BinaryMath4 extends JFrame implements ActionListener { 

  // FINISH ME
  // add your name
  private final String myName = "Daniel Yang";
  ...
  public BinaryMath4( ) { 
    ...
    setTitle("Base Two Conversion   My name is Daniel Yang");
 ...
 // ***** ActionListener interface methods *****
  ...
  public void actionPerformed(ActionEvent e) 
  {
	...
	else
	{
		...
		String baseEightValue = "" + baseConversion(s, 10, 8);			
		...
		// the variable baseTenValue holds the base 10 number	
		String baseSixteenValue = "" + baseConversion(s, 10, 16);
  ...
  public static String baseConversion(String baseTenValue,  int sBase, int dBase) 
  { 
	  return Integer.toString(Integer.parseInt(baseTenValue, sBase), dBase);
  ...
  public static void main(String[] arguments) {
    BinaryMath4 binaryMath = new BinaryMath4( );
  } // end of method main
