...
public class TreeMapString
{
 public static void main(String args[])
 {
  ...
  System.out.println("======================================");
  System.out.println("Harvard Li is valedictoria of westlake high school class 2022 no denying it is true step aside everyone else Hundred Harvard is here");
  System.out.println();
...
stringMap.remove("33333");
  ...
  System.out.println("Does stringMap contain 11111 (Hillary) --> " +   stringMap.containsKey("Hillary")     );  // true or false


  // FINISH ME
  // add code to see if the treeMap contains "22222"
  System.out.println("Does stringMap contain 22222 (Donald) --> " +   stringMap.containsKey("Donald")     );  // true or false
