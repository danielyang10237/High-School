...
{ 
  ...
  JLabel     titleLabel = new JLabel("Postfix Evaluator by your Daniel Yang");
  ...
  { 
	...
	setTitle("Postfix Evaluator  written by  Daniel Yang");
  ...
  public void calculateResult()
  {
		...
		// hint:  Loop through the expression 
		// if the next item is an integer 
		//     push it onto your stack
		// else
		//     it should be an operator
		//     so pop, pop, do the op, push
		...
		while (  scanExpression.hasNext()  )	
		{
			...
			// is an int
			if (scanExpression.hasNextInt() == true)
			{
				// FINISH ME
