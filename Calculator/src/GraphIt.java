...
{ 
 ...
 // set a mnemonic 'X' for the exitMenuItem
    ...
    northPanelLabel = new JLabel("Graph It! by Daniel Yang");
 ...
 // (call setSize and pass it 800 and 600)
    ...
    setTitle("Graph It!  by   Daniel Yang");
 ...
 // call the initialize() method
  ...
  if (source == null) // they pressed cancel
  {
   System.exit(0);// nothing to do so quit the method
  }
...
public class DrawPanel extends JPanel 
{
                    ...
                    int markHeight, int pixelsPerUnit)
 {
  ...
  // FINISH ME
  // draw the x axis
  gMemory.drawLine(0,middleY,lastX,middleY);
  ...
  {
   gMemory.drawLine(middleX+(pixelsPerUnit*i), middleY+markHeight, middleX+(pixelsPerUnit*i), middleY-markHeight); 
  



  // draw hash marks to the left of (middleX,middleY)
   gMemory.drawLine(middleX-(pixelsPerUnit*i), middleY+markHeight, middleX-(pixelsPerUnit*i), middleY-markHeight); 
                    ...
                    int markWidth, int pixelsPerUnit)
 {
  ...
  // FINISH ME
  // draw the y axis
gMemory.drawLine(middleX,0,middleX,lastY);
  ...
  {
  gMemory.drawLine(middleX+markWidth, middleY+(pixelsPerUnit*i), middleX-markWidth, middleY+(pixelsPerUnit*i));
