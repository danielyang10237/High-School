...
public class ArrayListStudentRunner extends JFrame implements ActionListener { 
  ...
  { 
	...
	lastStudentButton = new JButton("Last Student");
	...
	String titleString = "ArrayList <Student> BY Daniel Yang";
  ...
  { 
    ...
    // FINISH ME
    setTitle("ArrayList Math by XXXXXXXXX  YOUR NAME GOES HERE");
 ...
 // ***** ActionListener interface methods *****
  ...
  public void actionPerformed(ActionEvent e) {
	...
	else if (previousStudentButton == source)
	{
		displayStudent("previous");		
	}
	
	else if (lastStudentButton == source)
	{
		displayStudent("last");		
	}
