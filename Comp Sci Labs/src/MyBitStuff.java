...
public class MyBitStuff
{
	...
	public static void main(String args[])
	{
		...
		System.out.println("Written by Daniel Yang");
		System.out.println();
		System.out.println();
		...
		while (  !finished  )
		{
			...
			try
			{
				...
				else if (bitOperator.equals("~"))
				{
					...
					result2 = ~x;  // two's complement
					
					
					// FINISH ME
					// convert result1 into a binary string
					resultInBinary1 = Integer.toBinaryString(result1);
					...
					resultInBinary2 = Integer.toBinaryString(result2);
